...
include("Banco.php");
/*
http://localhost/SQL/AULA%2013/aluno_alterar.php?ra=11111
 1 - Receber via GET o RA do aluno
 2 - Buscar o auluno no banco de dados
...
<div class="container">
        ...
        <form action="admin_Alterar_sql.php" method="POST" enctype="multipart/form-data">
            <!-- Preview da imagem -->
            <div class="form-group">
                <label>Imagem do Produto</label>
                <div class="image-preview">
                    <!-- Exibe a imagem atual do produto -->
                    <img src="<?php echo $dados['imagem'] ?? 'imagem-padrao.jpg'; ?>" id="imagePreview" alt="Preview da imagem">
                </div>
            ...
            <div class="form-group">
                <label>Preço (R$)</label>
                <input type="number" name="preco" value="<?php echo $dados['preco']; ?>" min="0" step="0.01">
            </div>
            <div class="form-group">
                <label>Quantidade</label>
                <input type="number" name="quantidade" value="<?php echo $dados['quantidade']; ?>" min="0" step="0.01">
            </div>
            <div class="form-group">
